            ...
            <div
                ...
                <table
                    ...
                    <tbody>
                        <tr>
                            <td
                                style="border-bottom:#cb1c22 solid 5px;direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
                                <!--[if mso | IE]> <table role="presentation" border="0" cellpadding="0"
                                cellspacing="0"> <tr> </tr> </table> <![endif]-->
                            </td>
                        </tr>
                    </tbody>
                </table>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div
                                                    ...
                                                    <br>
                                                    <br>
                                                    Bạn có một khách hàng gừi câu hỏi đến! Thông tin như bên dưới:
                                                    <br>
                                                    <br>
                                                    <strong>Tên Khách Hàng:</strong> {{ $name }}
                                                    <br>
                                                    <strong>Email Khách Hàng:</strong> {{ $email }}
                                                    <br>
                                                    <strong>Chủ Đề Câu Hỏi:</strong> {{ $subject }}
                                                    <br>
                                                    <strong>Lời Nhắn/Câu Hỏi:</strong> {{ $comment }}
                                                    <br>
                                                    <br>
