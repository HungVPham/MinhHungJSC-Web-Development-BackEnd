    ...
    <div class="container">
        <div class="row">
            <div class="footer-col-1">
                ...
                <img loading="lazy" width="150px" src="{{ ('/images/front_images/tb_cong_thuong.png') }}" alt="dấu xác nhận đã thông báo bộ công thương">
            </div>
            <div class="footer-col-2">
                <div class="footerLogo">    
                    <a href="{{ url('') }}"><img loading="lazy" src="{{ ('/images/front_images/logoMinhHung.png') }}" alt="logo công ty"></a>
                </div>
