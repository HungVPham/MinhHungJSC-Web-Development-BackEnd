        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Các Trang Thông Ting</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Các Trang Thông Tin</h3>
                <a href="{{ url('admin/add-edit-cms-page') }}" class="btn btn-block btn-success" id="admin-btn">Thêm Trang Thông Tin</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td style="width: 50px;">
                      <a title="sửa trang thông tin" id="updatePage" href="{{ url('admin/add-edit-cms-page/'.$cms_page->id) }}"><i class="fas fa-edit"></i></a>
                      &nbsp; &nbsp;<a title="xóa trang thông tin" href="javascript:void(0)" class="confirmDelete" record="cms-page" recordid="{{ $cms_page->id }}"  class="confirmDelete" id="deletePage"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
