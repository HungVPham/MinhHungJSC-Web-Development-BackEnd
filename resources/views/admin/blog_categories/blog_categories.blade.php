...
<style>
    ...
    .updateBlogCategoryStatus:hover{color: #4c5158 !important}
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Thể Loại Tin Tức</h3>
                <a href="{{ url('admin/add-edit-blog-category') }}" class="btn btn-block btn-success"  id="admin-btn">Thêm Thể Loại</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  @foreach($categories as $category)
                    ...
                    <tr>
                      ...
                      <td style="width: 135px;">
                          ...
                          <a class="updateBlogCategoryStatus" id="category-{{ $category->id }}" category_id="{{ $category->id }}" href="javascript:void(0)" style="color: var(--Positive-Green);"><i id="active" style="color: var(--Positive-Green); font-size: 1.05rem;"  class="fas fa-toggle-on" aria-hidden="true"> đang hoạt động</i></a>   
                          @elseif ($category->status==0)
                          <a class="updateBlogCategoryStatus" id="category-{{ $category->id }}" category_id="{{ $category->id }}" href="javascript:void(0)" style="color: var(--Delete-Red);"><i id="inactive" style="color: var(--Delete-Red); font-size: 1.05rem;" class="fas fa-toggle-off" aria-hidden="true"> chưa hoạt động</i></a> 
                          @endif
                      </td>
                      <td style="width: 50px;">
                        <a title="sửa thể loại" id="updateCategory" href="{{ url('admin/add-edit-blog-category/'.$category->id) }}"><i class="fas fa-edit"></i></a>
