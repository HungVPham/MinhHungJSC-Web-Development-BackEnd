...
<div class="small-container cart-page">
    ...
    @if(!empty($userCartItems)) 
        ...
        <div class="voucher-containter">
            <form id="ApplyCoupon" method="post" action="javascript:void(0);" @if(Auth::check()) user="1" @endif>@csrf
                ...
                <input class="voucher" required name="code" id="code" type="text">
                <button type="submit" style="width: 161.05px;" class="btn">Áp Dụng</button>
            </form>
            <p><button onclick="goBack()" class="btn">&larr; Quay Trở Lại</button><button class="btn">Mua Hàng</button></p>
        </div>
    @else
    <div class="empty-cart">
        ...
        <p><button onclick="goBack()" class="btn">&larr; Quay Trở Lại</button></p>
    </div>
    @endif
    </div>
</div>
