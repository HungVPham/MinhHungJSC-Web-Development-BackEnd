...
<div class="contact-page">
    <section id="contact">
        ...
        <form action="{{ url('/lien-he') }}" method="post">@csrf
        <div class="contact-box">
            ...
            <div class="c-inputs">
                ...
                <input type="subject" name="subject" placeholder="Chủ Đề"/> 
                <textarea type="text" name="message" placeholder="lời nhắn hay câu hỏi của bạn..."></textarea>
