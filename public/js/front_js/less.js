//
// LESS - Leaner CSS v1.3.1 http://lesscss.org
//
// Copyright (c) 2009-2011, Alexis Sellier Licensed under the Apache 2.0
// License.
//
(function (e, t) {
    function n(t) {
    ...
    function d(t, n, i, s) {
        ...
        /^[a-z-]+:/.test(f) || (
            f.charAt(0) == "/"
                ? f = e.location.protocol + "//" + e.location.host + f
                : f = a.slice(0, a.lastIndexOf("/") + 1) + f
        ),
        g(t.href, t.type, function (e, u) {
        ...
        if (r.styleSheet) 
            ...
            (function (e) {
                    r.childNodes.length > 0
                        ? r.firstChild.nodeValue !== e.nodeValue && r.replaceChild(e, r.firstChild)
                        : r.appendChild(e)
                }
    ...
    function g(e, t, n, i) {
        ...
        var o = y(),
            u = s
                ? r.fileAsync
                : r.async;
        typeof o.overrideMimeType == "function" && o.overrideMimeType("text/css"),
        o.open("GET", e, u),
        o.setRequestHeader("Accept", t || "text/x-less, text/css; q=0.9, */*; q=0.5"),
        o.send(null),
        s && !r.fileAsync
            ? o.status === 0 || o.status >= 200 && o.status < 300
                ? n(o.responseText)
                : i(o.status, e)
            : u
    ...
    function y() {
        ...
        try {
            ...
            return w("browser doesn't support AJAX."),
            null
        }
    }
    function b(e) {
    ...
    function w(e) {
        r.env == "development" && typeof console != "undefined" && console.log(
            "less: " + e
        )
    }
    function E(e, t) {
        ...
        var c = function (e, t, n) {
            e.extract[t] && a.push(
                i.replace(/\{line\}/, parseInt(e.line) + (t - 1)).replace(/\{class\}/, n).replace(/\{content\}/, e.extract[t])
            )
        };
        e.stack
            ? u += "<br/>" + e
        ...
        r.env == "development" && (o = setInterval(function () {
            document.body && (
    ...
    Array.isArray || (Array.isArray = function (e) {
        return Object
            .prototype
            .toString
            .call(e) === "[object Array]" || e instanceof Array
    }),
    ...
    typeof environment == "object" && {}
        .toString
        .call(environment) === "[object Environment]"
            ? (
                typeof e == "undefined"
                    ? r = {}
                    : r = e.less = {},
        ...
        var v = function () {},
            m = this.imports = {
                ...
                push: function (e, n) {
                    ...
                    r
                        .Parser
                        .importer(e, this.paths, function (t, r) {
                            i
                                .queue
                                .splice(i.queue.indexOf(e), 1);
                            var s = e in i.files;
                            i.files[e] = r,
                            t && !i.error && (i.error = t),
                            n(t, r, s),
                            i.queue.length === 0 && v(t)
                        }, t)
                }
            };
        return this.env = t = t || {},
        this.optimization = "optimization" in this.env
            ...
            parse: function (e, a) {
                ...
                c = function (e) {
                    ...
                    for (var c = 0, h, p; c < s.length; c++) {
                        r.lastIndex = c,
                        (a = r.exec(s)) && a.index === c && (c += a[0].length, f.push(a[0])),
                        h = s.charAt(c),
                        i.lastIndex = o.lastIndex = c,
                        (a = o.exec(s)) && a.index === c && (
                            c += a[0].length,
                            f.push(a[0]),
                            h = s.charAt(c)
                        ),
                        !l && h === "/" && (
                            p = s.charAt(c + 1),
                            (p === "/" || p === "*") && (a = i.exec(s)) && a.index === c && (c += a[0].length, f.push(a[0]), h = s.charAt(c))
                        );
                        switch (h) {
                            case "{":
                                if (!l) {
                ...
                if (x) 
                    return a(x);
                try {
                    f = new i.Ruleset([], E(this.parsers.primary)),
                    f.root = !0
                } catch (T) {
                    return a(new O(T, t))
                }
            ...
            parsers: {
                primary: function () {
                    var e,
                        t = [];
                    while (
                        (e = E(this.mixin.definition) || E(this.rule) || E(this.ruleset) || E(this.mixin.call) || E(this.comment) || E(this.directive)) || E(/^[\s\n]+/)
                    ) 
                        e && t.push(e);
                    return t
                },
                ...
                entities: {
                    ...
                    literal: function () {
                        return E(this.entities.ratio) || E(this.entities.dimension) || E(
                            this.entities.color
                ...
                mixin: {
                    ...
                    definition: function () {
                        ...
                        if (n = E(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)) {
                            ...
                            E(")") || (l = o, y()),
                            E(/^when/) && (f = x(this.conditions, "expected condition")),
                            r = E(this.block);
                            if (r) 
                                return new i
                                    .mixin
                                    .Definition(e, t, r, f, c);
                            y()
                        }
                    }
                },
                entity: function () {
                    return E(this.entities.literal) || E(this.entities.variable) || E(
                        this.entities.url
                    ) || E(this.entities.call) || E(this.entities.keyword) || E(
                ...
                element: function () {
                    ...
                    e || E("(") && (
                        r = E(this.entities.variableCurly) || E(this.entities.variable)
                    ) && E(")") && (e = new i.Paren(r));
                    if (e) 
                ...
                attribute: function () {
                    ...
                    if (t = E(/^(?:[_A-Za-z0-9-]|\\.)+/) || E(this.entities.quoted)) 
                        (r = E(/^[|~*$^]?=/)) && (n = E(this.entities.quoted) || E(/^[\w-]+/))
                            ? e = [
                                t, r, n.toCSS
                                    ? n.toCSS()
                                    : n
                ...
                ruleset: function () {
                    ...
                    if (e.length > 0 && (r = E(this.block))) {
                        ...
                        return t.dumpLineNumbers && (f.debugInfo = a),
                        f
                    }
                    l = o,
                    y()
                ...
                directive: function () {
                    ...
                    e = E(/^@[a-z-]+/),
                    f = e,
                    e.charAt(1) == "-" && e.indexOf("-", 2) > 0 && (f = "@" + e.slice(
                        e.indexOf("-", 2) + 1
                    ));
                    switch (f) {
                        case "@font-face":
                ...
                addition: function () {
                    ...
                    if (e = E(this.multiplication)) {
                        while (
                            (n = E(/^[-+]\s+/) || !w(s.charAt(o - 1)) && (E("+") || E("-"))) && (t = E(this.multiplication))
                        ) 
                            r = new i.Operation(n, [
                                r || e,
                                t
                ...
                condition: function () {
                    ...
                    if (e = E(this.addition) || E(this.entities.keyword) || E(this.entities.quoted)) 
                        return (r = E(/^(?:>=|=<|[<=>])/))
                            ? (t = E(this.addition) || E(this.entities.keyword) || E(this.entities.quoted))
                                ? n = new i.Condition(r, e, t, s, u)
                                : T("expected expression")
                            : n = new i.Condition("=", e, new i.Keyword("true"), s, u),
                        x(")"),
                        E(/^and/)
                            ? new i.Condition("and", n, E(this.condition))
                            : n
                    },
                operand: function () {
                    var e,
                    ...
                    return e
                        ? new i.Operation("*", [new i.Dimension(-1), n])
                        : n
                },
                expression: function () {
                    var e,
        ...
        e.functions = {
            ...
            luma: function (t) {
                return new e.Dimension(
                    Math.round((.2126 * (t.rgb[0] / 255) + .7152 * (t.rgb[1] / 255) + .0722 * (t.rgb[2] / 255)) * t.alpha * 100),
                    "%"
                )
            },
            saturate: function (e, n) {
                var i = e.toHSL();
                return i.s += n.value / 100,
                i.s = r(i.s),
                t(i)
            },
            ...
            contrast: function (e, t, n, r) {
                return typeof n == "undefined" && (n = this.rgba(255, 255, 255, 1)),
                typeof t == "undefined" && (t = this.rgba(0, 0, 0, 1)),
                typeof r == "undefined"
                    ? r = .43
                    : r = r.value,
                (
                    .2126 * (e.rgb[0] / 255) + .7152 * (e.rgb[1] / 255) + .0722 * (e.rgb[2] / 255)
                ) * e.alpha < r
                    ? n
                    : t
            },
            ...
            escape: function (t) {
                return new e.Anonymous(
                    encodeURI(t.value).replace(/=/g, "%3D").replace(/:/g, "%3A").replace(/#/g, "%23").replace(/;/g, "%3B").replace(/\(/g, "%28").replace(/\)/g, "%29")
                )
            },
            "%": function (t) {
                var n = Array
            ...
            ispixel: function (t) {
                return t instanceof e.Dimension && t.unit === "px"
                    ? e.True
                    : e.False
            },
            ...
            isem: function (t) {
                return t instanceof e.Dimension && t.unit === "em"
                    ? e.True
                    : e.False
            },
            _isa: function (t, n) {
    ...
    function (e) {
        ...
        e.Alpha.prototype = {
            ...
            eval: function (e) {
                return this.value.eval && (this.value = this.value.eval(e)),
                this
            }
        }
    }(n("../tree")),
    ...
    function (e) {
        ...
        e.Color.prototype = {
            ...
            compare: function (e) {
                return e.rgb
                    ? e.rgb[0] === this.rgb[0] && e.rgb[1] === this.rgb[1] && e.rgb[2] === this.rgb[2] && e.alpha === this.alpha
                        ? 0
                        : -1
                    : -1
            }
    ...
    function (e) {
        e.Directive = function (t, n) {
            this.name = t,
            Array.isArray(n)
                ? (this.ruleset = new e.Ruleset([], n), this.ruleset.allowImports = !0)
                : this.value = n
        },
        e.Directive.prototype = {
            toCSS: function (e, t) {
                return this.ruleset
                    ? (this.ruleset.root = !0, this.name + (
                        t.compress
                            ? "{"
                            : " {\n  "
    ...
    function (e) {
        e.Element = function (t, n, r) {
            this.combinator = t instanceof e.Combinator
                ? t
                : new e.Combinator(t),
            typeof n == "string"
                ? this.value = n.trim()
        ...
        e.Expression.prototype = {
            eval: function (t) {
                return this.value.length > 1
                    ? new e.Expression(this.value.map(function (e) {
                        return e.eval(t)
                    }))
                    : this.value.length === 1
                        ? this
    ...
    function (e) {
        e.Import = function (t, n, r, i, s) {
            ...
            t instanceof e.Quoted
                ? this.path = /\.(le?|c)ss(\?.*)?$/.test(t.value)
                    ? t.value
                    : t.value + ".less"
                : this.path = t.value.value || t.value,
            this.css = /css(\?.*)?$/.test(this.path),
            this.css || n.push(this.path, function (t, n, r) {
                t && (t.index = s),
                r && o.once && (o.skip = r),
                o.root = n || new e.Ruleset([], [])
            })
        },
        e.Import.prototype = {
            toCSS: function (e) {
            ...
            eval: function (t) {
                ...
                for (var i = 0; i < n.rules.length; i++) 
                    n.rules[i] instanceof e.Import && Array
                        .prototype
                        .splice
                        .apply(n.rules, [i, 1].concat(n.rules[i].eval(t)));
        ...
        e.Media.prototype = {
            toCSS: function (e, t) {
                var n = this
                    .features
                    .toCSS(t);
                return this.ruleset.root = e.length === 0 || e[0].multiMedia,
                "@media " + n + (
                    t.compress
                        ? "{"
                        : " {\n  "
            ...
            evalTop: function (t) {
                ...
                if (t.mediaBlocks.length > 1) {
                    var r = this.emptySelectors();
                    n = new e.Ruleset(r, t.mediaBlocks),
                    n.multiMedia = !0
                }
            ...
            evalNested: function (t) {
                ...
                for (n = 0; n < i.length; n++) 
                    r = i[n].features instanceof e.Value
                        ? i[n].features.value
                        : i[n].features,
                    i[n] = Array.isArray(r)
                        ? r
            ...
            eval: function (e) {
                ...
                for (var s = 0; s < e.frames.length; s++) 
                    if ((t = e.frames[s].find(this.selector)).length > 0) {
                            ...
                            if (t[o].match(n, e)) 
                                try {
                                    Array
                                        .prototype
                                        .push
                                        .apply(r, t[o].eval(e, this.arguments, this.important).rules),
                                    i = !0
                                } catch (u) {
                                    throw {
                                        message : u.message,
                        ...
                        throw {
                            type : "Runtime",
                            message: "No matching definition was found for `" + this
                                .selector
                                .toCSS()
                                .trim() + "(" + this
                                .arguments
        ...
        e.mixin.Definition.prototype = {
            ...
            evalParams: function (t, n) {
                ...
                for (var o = 0, u, a; o < this.params.length; o++) {
                    ...
                    if (s && s.name) {
                        r
                            .rules
                            .unshift(new e.Rule(s.name, s.value.eval(t))),
                        n.splice(o, 1),
                        o--;
                        continue
                    }
                    if (a = this.params[o].name) 
                        if (this.params[o].variadic && n) {
                            ...
                            r
                                .rules
                                .unshift(new e.Rule(a, (new e.Expression(i)).eval(t)))
                        }
                    else {
                        if (!(u = s && s.value || this.params[o].value)) 
                            throw {
                                type : "Runtime",
                                message: "wrong number of arguments for " + this.name + " (" + n.length + " for " +
                                        this.arity + ")"
                            };
                        r
                            .rules
                            .unshift(new e.Rule(a, u.eval(t)))
                    }
                }
                return r
            },
            eval: function (t, n, r) {
                ...
                for (var f = 0; f < Math.max(this.params.length, n && n.length); f++) 
                    o.push(n[f] && n[f].value || this.params[f].value);
                return i
                    .rules
                    .unshift(new e.Rule("@arguments", (new e.Expression(o)).eval(t))),
                u = r
                    ? this
                        .rules
                        .map(function (t) {
            ...
            match: function (e, t) {
                ...
                for (var s = 0; s < r; s++) 
                    if (!this.params[s].name && e[s].value.eval(t).toCSS() != this.params[s].value.eval(t).toCSS()) 
                        return !1;
            return !0
            }
        }
                ...
                var n = this,
                    r = this
                        ...
                        .replace(/`([^`]+)`/g, function (r, i) {
                            return (new e.JavaScript(i, n.index, !0))
                                .eval(t)
                                .value
                        })
    ...
    function (e) {
        e.Rule = function (t, n, r, i, s) {
            this.name = t,
            this.value = n instanceof e.Value
                ? n
                : new e.Value([n]),
            this.important = r
                ? " " + r.trim()
        ...
        e.Ruleset.prototype = {
            eval: function (t) {
                ...
                if (r.root || r.allowImports || !r.strictImports) {
                    for (var s = 0; s < r.rules.length; s++) 
                        r.rules[s] instanceof e.Import
                            ? i = i.concat(r.rules[s].eval(t))
                            : i.push(r.rules[s]);
                    r.rules = i,
                    i = []
                }
            ...
            variables: function () {
                return this._variables
                    ? this._variables
                    : this._variables = this
                        .rules
                        .reduce(function (t, n) {
                            return n instanceof e.Rule && n.variable === !0 && (t[n.name] = n),
                            t
                        }, {})
            },
            variable: function (e) {
                                    ...
                                    t.elements.length > i
                                        ...
                                        .length
                                            ? Array
                                                .prototype
                                                .push
                                                .apply(r, i.find(new e.Selector(t.elements.slice(1)), n))
                                            : r.push(i);
                                    break
                                }
                            }), this._lookups[o] = r)
            ...
            toCSS: function (t, n) {
                ...
                for (var c = 0; c < this.rules.length; c++) 
                    l = this.rules[c],
                    l.rules || l instanceof e.Directive || l instanceof e.Media
                        ? o.push(l.toCSS(u, n))
                        ...
                        for (s = 0; s < a.length; s++) {
                            ...
                            if (n.length == 0) 
                                ...
                                for (o = 0; o < n.length; o++) 
                                    ...
                                    c.length > 0 && (
                                        v = !1,
                                        d.elements.push(new e.Element(f.combinator, c[0].elements[0].value, 0)),
            ...
            mergeElementsOnToSelectors: function (t, n) {
                ...
                for (r = 0; r < n.length; r++) 
                    i = n[r],
                    i.length > 0
                        ? i[i.length - 1] = new e.Selector(i[i.length - 1].elements.concat(t))
        ...
        t.URL.prototype = {
            ...
            eval: function (n) {
                var r = this
                    .value
                    .eval(n);
                return typeof e != "undefined" && typeof r.value == "string" && !/^(?:[a-z-]+:|\/)/.test(
                    r.value
                ) && this.paths.length > 0 && (r.value = this.paths[0] + (
                    r.value.charAt(0) === "/"
                        ? r.value.slice(1)
                        : r.value
                )),
                new t.URL(r, this.paths)
            }
        }
    }(n("../tree")),
    function (e) {
            ...
            eval: function (t) {
                return this.value.length === 1
                    ? this
                        .value[0]
                        .eval(t)
                    : new e.Value(this.value.map(function (e) {
                        return e.eval(t)
                    }))
            },
            toCSS: function (e) {
    ...
    function (e) {
        ...
        e.debugInfo.asMediaQuery = function (e) {
            return '@media -sass-debug-info{filename{font-family:"' + e.debugInfo.fileName +
                    '";}line{font-family:"' + e.debugInfo.lineNumber + '";}}\n'
        },
        e.find = function (e, t) {
    ...
    r.env = r.env || (
        location.hostname == "127.0.0.1" || location.hostname == "0.0.0.0" || location.hostname == "localhost" || location.port.length > 0 || s
            ? "development"
            : "production"
    ),
    r.async = r.async || !1,
    ...
    var u;
    try {
        u = typeof e.localStorage == "undefined"
            ? null
            : e.localStorage
    } catch (a) {
        u = null
    ...
    for (var c = 0; c < f.length; c++) 
        (
            f[c].rel === "stylesheet/less" || f[c].rel.match(/stylesheet/) && f[c].type.match(l)
        ) && r
            .sheets
            .push(f[c]);
    r.refresh = function (e) {
        var t,
            n;
        t = n = new Date,
        p(function (e, r, i, s, o) {
            o.local
                ? w("loading " + s.href + " from cache.")
                : (w("parsed " + s.href + " successfully."), m(r.toCSS(), s, o.lastModified)),
            w("css for " + s.href + " generated in " + (
                new Date - n
            ) + "ms"),
            o.remaining === 0 && w("css generated in " + (
                new Date - t
            ) + "ms"),
            n = new Date
        }, e),
