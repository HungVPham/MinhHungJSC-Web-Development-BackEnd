/* !
* Stack Developers.js by @fat & @mdo
...
!function (e) {
    ...
    t.prototype = {
        ...
        pause: function (t) {
            ...
            this
                .$element
                .find(".next, .prev")
                .length && e.support.transition.end && (
    ...
    e(document).on("click.carousel.data-api", "[data-slide]", function (t) {
        var n = e(this),
            r,
            i = e(
                n.attr("data-target") || (r = n.attr("href")) && r.replace(/.*(?=#[^\s]+$)/, "")
            ),
...
!function (e) {
    ...
    t.prototype = {
        ...
        reset: function (e) {
            ...
            return this
                .$element
                .removeClass("collapse")[t](e || "auto")[0]
                .offsetWidth,
            this.$element[
                e !== null
                    ? "addClass"
        ...
        transition: function (t, n, r) {
            ...
            this.$element[t]("in"),
            e.support.transition && this
                .$element
                .hasClass("collapse")
                    ? this
                        .$element
                        .one(e.support.transition.end, s)
                    : s()
        },
        toggle: function () {
            this[
    ...
    e(document).on(
        ...
        function (t) {
            var n = e(this),
                r,
                i = n.attr("data-target") || t.preventDefault() || (r = n.attr("href")) && r.replace(
                    /.*(?=#[^\s]+$)/,
                    ""
                ),
                s = e(i).data("collapse")
    ...
    t.prototype = {
        ...
        escape: function () {
            ...
            this.isShown && this.options.keyboard
                ? this
                    .$element
                    .on("keyup.dismiss.modal", function (t) {
                        t.which == 27 && e.hide()
                    })
                : this.isShown || this
                    .$element
...
!function (e) {
    ...
    t.prototype = {
        ...
        init: function (t, n, r) {
            ...
            this.options.trigger == "click"
                ? this
                    .$element
                    .on("click." + this.type, this.options.selector, e.proxy(this.toggle, this))
                : this.options.trigger != "manual" && (
                    i = this.options.trigger == "hover"
                        ? "mouseenter"
                        : "focus",
                    s = this.options.trigger == "hover"
                        ? "mouseleave"
                        : "blur",
                    this.$element.on(
                        i + "." + this.type,
        ...
        show: function () {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                s = typeof this.options.placement == "function"
                    ? this
                        .options
                        .placement
        ...
        fixTitle: function () {
            var e = this.$element;
            (e.attr("title") || typeof e.attr("data-original-title") != "string") && e
                .attr(
                    "data-original-title",
                    e.attr("title") || ""
                )
    ...
    e.fn.tooltip.defaults = {
        ...
        placement: "top",
        selector: !1,
        template: '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inne' +
                'r"></div></div>',
        trigger: "hover",
        title: "",
        delay: 0,
...
!function (e) {
    ...
    e.fn.popover.defaults = e.extend({}, e.fn.tooltip.defaults, {
        ...
        trigger: "click",
        content: "",
        template: '<div class="popover"><div class="arrow"></div><div class="popover-inner"><h3 c' +
                'lass="popover-title"></h3><div class="popover-content"><p></p></div></div></di' +
                'v>'
    })
}(window.jQuery),
!function (e) {
    ...
    t.prototype = {
        ...
        activate: function (t) {
            ...
            n
                ...
                .length && (n = n.closest("li.dropdown").addClass("active")),
            n.trigger("activate")
        }
    },
...
!function (e) {
    ...
    t.prototype = {
        ...
        activate: function (t, n, r) {
            ...
            s
                ? i.one(e.support.transition.end, o)
                : o(),
            i.removeClass("in")
        }
    },
...
!function (e) {
    ...
    t.prototype = {
        ...
        process: function (t) {
            ...
            t.length
                ? this
                    .render(t.slice(0, this.options.items))
                    .show()
                : this.shown
                    ? this.hide()
                    : this
        ...
        sorter: function (e) {
            ...
            while (i = e.shift()) 
                i
                    .toLowerCase()
                    .indexOf(this.query.toLowerCase()) ?~ i.indexOf(this.query)
                        ? n.push(i)
                        : r.push(i): t.push(i);
            return t.concat(n, r)
        },
        ...
        listen: function () {
            ...
            this.eventSupported("keydown") && this
                .$element
                .on("keydown", e.proxy(this.keydown, this)),
            this
                .$menu
...
!function (e) {
    ...
    t.prototype.checkPosition = function () {
        ...
        a = this.unpin != null && n + this.unpin <= r.top
            ? !1
            : s != null && r.top + this
                .$element
                .height() >= t - s
