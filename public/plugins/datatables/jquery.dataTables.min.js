...
- 1 != d && c === k && a.splice(d, 1)
                ...
                G = function (a) {
                    if (c === k || c === i) 
                        ...
                        h = a
                            ...
                            .trim(),
                        j && j._bAttrSrc
                            ? (N(j.mData._)(d, h), u(j.mData.sort, a), u(j.mData.type, a), u(
                                j.mData.filter,
                                a
                            ))
                            : q
        ...
        function nb(a) {
            return a.bAjaxDataGet
                ? (a.iDraw++, D(a, !0), ta(a, wb(a), function (b) {
                    xb(a, b)
                }), !1)
                : !0
        }
        function wb(a) {
            ...
            for (g = 0; g < c; g++) 
                ...
                u("mDataProp_" + g, i),
                d.bFilter && (u("sSearch_" + g, l.sSearch), u("bRegex_" + g, l.bRegex), u(
                    "bSearchable_" + g,
                    m.bSearchable
                )),
        ...
        function ma(a) {
            ...
            if (a.scrollBarVis !== L && a.scrollBarVis !== k) 
                ...
                if ("" === c) {
                    t.width = "100%";
                    if (V && (p.find("tbody").height() > j.offsetHeight || "scroll" == l.css("overflow-y"))) 
                        t.width = w(p.outerWidth() - b);
                    f = p.outerWidth()
                } else 
                    "" !== d && (t.width = w(d), f = p.outerWidth());
                I(B, L);
                I(function (a) {
                    y.push(a.innerHTML);
                ...
                if (p.outerWidth() < f) {
                    Q = j.scrollHeight > j.offsetHeight || "scroll" == l.css("overflow-y")
                        ? f + b
                        : f;
                    if (V && (j.scrollHeight > j.offsetHeight || "scroll" == l.css("overflow-y"))) 
                        t.width = w(Q - b);
        ...
        function ya(a) {
            ...
            if (e.bSort && e.bSortClasses) {
                ...
                for (f = b.length; e < f; e++) 
                    g = b[e].src,
                    h(C(a.aoData, "anCells", g)).removeClass(c + (
                        2 > e
                            ? e + 1
                            : 3
                    ));
                ...
                for (f = d.length; e < f; e++) 
                    g = d[e].src,
                    h(C(a.aoData, "anCells", g)).addClass(c + (
                        2 > e
                            ? e + 1
                            : 3
                    ))
            ...
            for (e in b) 
                b.hasOwnProperty(e) && (
                    ...
                    h.isPlainObject(d)
                        ...
                        : a[e] = c && "data" !== e && "aaData" !== e && Array.isArray(d)
                            ? d.slice()
                            : d
                );
            return a
        ...
        var n = function (a) {
            ...
            this.api = function (a) {
                return a
                    ? new r(Aa(this[v.iApiIndex]))
                    : new r(this)
            };
            this.fnAddData = function (a, b) {
                var c = this.api(!0),
                    d = Array.isArray(a) && (Array.isArray(a[0]) || h.isPlainObject(a[0]))
                        ? c
                            .rows
                            .add(a)
                        : c
                    ...
                    if (a.nodeName) {
                        ...
                        if (b !== k) 
                            return i[b] && i[b].nTr === a
                                ...
                                : [];
                        if (m) 
                            return i[m.row] && i[m.row].nTr === a.parentNode
                                ? [m.row]
                                : [];
    ...
    o("destroy()", function (a) {
        ...
        return this.iterator("table", function (b) {
            ...
            if (!a && c) {
                ...
                i
                    .css("width", b.sDestroyWidth)
                    .removeClass(d.sTable);
                (o = b.asDestroyStripes.length) && f
                    .children()
                    .each(function (a) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Hiện thị từ _START_ tới _END_ trên _TOTAL_ mục dữ liệu.",
            sInfoEmpty: "Hiện thị 0 tới 0 trên 0 mục dữ liệu.",
            sInfoFiltered: "(lọc từ _MAX_ tổng mục dữ liệu)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Hiện thị _MENU_ mục dữ liệu.",
            sLoadingRecords: "Đang tải...",
            sProcessing: "Đang sử lý...",
            sSearch: "Tìm Kiếm:",
            sSearchPlaceholder: "",
            sUrl: "",
