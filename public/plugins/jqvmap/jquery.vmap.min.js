...
var VectorCanvas = function (a, b, c) {
    if (
        ...
        try {
            document.namespaces.rvml || document
                .namespaces
...
var JQVMap = function (a) {
    ...
    if (!d) 
        throw new Error(
            'Invalid "' + a.map + '" map parameter. Please make sure you have loaded this m' +
            'ap file in your HTML.'
        );
    ...
    if (
        ...
        jQuery(a.container).delegate(
            ...
            function (b) {
                ...
                if (f = f.toLowerCase(), jQuery(a.container).trigger(g, [
                    f, d
                        .paths[f]
                        .name
                    ...
                    for (var h in d.paths) 
                        ...
                        c
                            .countries[h]
                            .setFill(c.countries[h].getOriginalFill());
                g.isDefaultPrevented() || (
                    c.isSelected(f)
                        ? c.deselect(f, e)
                        : c.select(f, e)
...
JQVMap.prototype.applyTransform = function () {
    ...
    this
        .canvas
        .applyTransformParams(this.scale, this.transX, this.transY)
},
...
JQVMap.prototype.deselect = function (a, b) {
    if (
        ...
        for (var c in this.countries) 
            this
                .selectedRegions
                .splice(this.selectedRegions.indexOf(c), 1),
            this
                .countries[c]
                .currentFillColor = this.color,
            this
                .countries[c]
                .setFill(this.color)
    },
    ...
    jQuery(this.container).bind("touchmove", function (a) {
        ...
        if (1 === n.length) {
            ...
            2 === n.length && (
                2 === e
                    ? (
                        c = Math.sqrt(Math.pow(n[0].pageX - n[1].pageX, 2) + Math.pow(n[0].pageY - n[1].pageY, 2)) / h,
                        d.setScale(i * c, f, g),
                        a.preventDefault()
                    )
                    : (
                        b = jQuery(d.container).offset(),
                        f = n[0].pageX > n[1].pageX
                            ? n[1].pageX + (n[0].pageX - n[1].pageX) / 2
                            : n[0].pageX + (n[1].pageX - n[0].pageX) / 2,
                        g = n[0].pageY > n[1].pageY
            ...
            ? jQuery.each(a, function (a, b) {
                if (0 !== jQuery("#" + c.getCountryId(a)).length) {
                    ...
                    c
                        .container
                        .append(
                            '<div id="' + d + '" for="' + a + '" class="jqvmap-pin" style="position:absolut' +
                            'e">' + b + "</div>"
                        )
                }
            })
...
JQVMap.prototype.zoomIn = function () {
    var a = this,
        b = (jQuery("#zoom").innerHeight() - 12 - 30 - 6 - 7 - 6) / (
...
VectorCanvas.prototype.applyTransformParams = function (a, b, c) {
    "svg" === this.mode
        ? this
            .rootGroup
            .setAttribute("transform", "scale(" + a + ") translate(" + b + ", " + c + ")")
        : (this.rootGroup.coordorigin = this.width - b + "," + (
            this.height - c
...
VectorCanvas.prototype.createPath = function (a) {
    ...
    if ("svg" === this.mode) 
        ...
        null !== this.params.borderColor && b.setAttribute(
            "stroke",
        ...
        this.params.borderOpacity > 0 && b.setAttribute(
            "stroke-opacity",
