    ...
    g.extend(e.ext.buttons, {
        colvis: function (a, b) {
            return {
                extend: "collection",
                text: function (b) {
                    return b.i18n("buttons.colvis", "Hiện Thị")
                },
        ...
        columnVisibility: {
            ...
            init: function (a, b, c) {
                ...
                a
                    .on("column-visibility.dt" + c.namespace, function (b, e) {
                        !e.bDestroying && e.nTable == a
                            .settings()[0]
                            .nTable && d.active(a.column(c.columns).visible())
                    })
            ...
            destroy: function (a, b, c) {
                a
                    .off("column-visibility.dt" + c.namespace)
